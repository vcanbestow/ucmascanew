  ...
  return (
    <div className="w-full   overflow-hidden select-none">
      <div className="">
        ...
        {/* ========================================================================= */}
        {/* DESKTOP LAYOUT (Strict Tailwind Fluid Grid Framework)                     */}
        {/* ========================================================================= */}
        <div className="hidden lg:relative lg:block w-full h-auto aspect-[1200/500]">
          
          {/* Responsive Fluid SVG Track */}
          <svg
          ...
          {/* Absolute Nodes Layout Positioned accurately based on Image Map specs */}
          
          {/* 1. 1993 - LINE LEFTSIDE (Content: text-right) */}
          <motion.div variants={contentVariants(0.2)} initial="hidden" whileInView="visible" viewport={{ once: true }} 
            className="absolute flex flex-col items-end text-right w-44 -translate-y-1/2 pr-6" 
            style={{ left: "5%", top: "45%" }}
          >
            <img src={TIMELINE_DATA[0].img} alt="" className="w-10 h-10 rounded-full mb-1 border border-white" />
            <p className="text-[.7rem] font-medium text-[#4A5568] leading-tight">{TIMELINE_DATA[0].text}</p>
            <div className="relative w-full mt-0.5">
              <h4 className="text-base font-black text-[#EF4444]">{TIMELINE_DATA[0].year}</h4>
              <div className=" w-3.5 h-3.5 rounded-full bg-[#EF4444] border-2 border-white absolute -right-6 top-1/2 -translate-y-1/2 shadow-sm z-20" />
            </div>
          </motion.div>

          {/* 2. 2004 - LINE TOP (Content: text-center) */}
          ...
          >
            ...
            <p className="text-[.7rem] font-medium text-[#4A5568] leading-tight">{TIMELINE_DATA[1].text}</p>
            <h4 className="text-base font-black text-[#EF4444] mt-0.5">{TIMELINE_DATA[1].year}</h4>
            <div className=" w-3.5 h-3.5 rounded-full bg-[#EF4444] border-2 border-white absolute -bottom-10 shadow-sm z-20" />
          </motion.div>

          {/* 3. 2006 - LINE LEFTSIDE (Content: text-right) */}
          <motion.div variants={contentVariants(0.6)} initial="hidden" whileInView="visible" viewport={{ once: true }} 
            className="absolute flex flex-col items-end text-right w-44 -translate-y-1/2 pr-6" 
            style={{ left: "25.5%", top: "72%" }}
          >
            <img src={TIMELINE_DATA[2].img} alt="" className="w-10 h-10 rounded-full mb-1 border border-white" />
            <p className="text-[.7rem] font-medium text-[#4A5568] leading-tight">{TIMELINE_DATA[2].text}</p>
            <div className="relative w-full mt-0.5">
              <h4 className="text-base font-black text-[#EF4444]">{TIMELINE_DATA[2].year}</h4>
              <div className=" w-3.5 h-3.5 rounded-full bg-[#EF4444] border-2 border-white absolute -right-6 top-1/2 -translate-y-1/2 shadow-sm z-20" />
            </div>
          </motion.div>

          {/* 4. 2011 - LINE LEFTSIDE (Content: text-right) */}
          <motion.div variants={contentVariants(0.8)} initial="hidden" whileInView="visible" viewport={{ once: true }} 
            className="absolute flex flex-col items-end text-right w-44 -translate-y-1/2 pr-6" 
            style={{ left: "39%", top: "82%" }}
          >
            <img src={TIMELINE_DATA[3].img} alt="" className="w-10 h-10 rounded-full mb-1 border border-white" />
            <p className="text-[.7rem] font-medium text-[#4A5568] leading-tight">{TIMELINE_DATA[3].text}</p>
            <div className="relative w-full mt-0.5">
              <h4 className="text-base font-black text-[#EF4444]">{TIMELINE_DATA[3].year}</h4>
              <div className=" w-3.5 h-3.5 rounded-full bg-[#EF4444] border-2 border-white absolute -right-6 top-1/2 -translate-y-1/2 shadow-sm z-20" />
            </div>
          </motion.div>

          {/* 5. 2016 - LINE TOP (Content: text-center) */}
          ...
          >
            ...
            <p className="text-[.7rem] font-medium text-[#4A5568] leading-tight">{TIMELINE_DATA[4].text}</p>
            <h4 className="text-base font-black text-[#EF4444] mt-0.5">{TIMELINE_DATA[4].year}</h4>
            <div className=" w-3.5 h-3.5 rounded-full bg-[#EF4444] border-2 border-white absolute -bottom-11 shadow-sm z-20" />
          </motion.div>

          {/* 6. 2017 - LINE RIGHTSIDE (Content: text-left) */}
          <motion.div variants={contentVariants(1.2)} initial="hidden" whileInView="visible" viewport={{ once: true }} 
            className="absolute flex flex-col items-start text-left w-44 -translate-y-1/2 pl-6" 
            style={{ left: "68%", top: "72%" }}
          >
            <img src={TIMELINE_DATA[5].img} alt="" className="w-10 h-10 rounded-full mb-1 border border-white" />
            <p className="text-[.7rem] font-medium text-[#4A5568] leading-tight">{TIMELINE_DATA[5].text}</p>
            <div className="relative w-full mt-0.5">
              <h4 className="text-base font-black text-[#EF4444]">{TIMELINE_DATA[5].year}</h4>
              <div className=" w-3.5 h-3.5 rounded-full bg-[#EF4444] border-2 border-white absolute -left-6 top-1/2 -translate-y-1/2 shadow-sm z-20" />
            </div>
          </motion.div>

          {/* 7. 2018 - LINE RIGHTSIDE (Content: text-left) */}
          <motion.div variants={contentVariants(1.4)} initial="hidden" whileInView="visible" viewport={{ once: true }} 
            className="absolute flex flex-col items-start text-left w-44 -translate-y-1/2 pl-6" 
            style={{ left: "76.5%", top: "54%" }}
          >
            <img src={TIMELINE_DATA[6].img} alt="" className="w-10 h-10 rounded-full mb-1 border border-white" />
            <p className="text-[.7rem] font-medium text-[#4A5568] leading-tight">{TIMELINE_DATA[6].text}</p>
            <div className="relative w-full mt-0.5">
          ...
          {/* 8. 2024 - LINE TOP (Content: text-center) */}
          <motion.div variants={contentVariants(1.6)} initial="hidden" whileInView="visible" viewport={{ once: true }} 
            ...
            style={{ left: "84.2%", top: "0%" }}
          >
            <img src={TIMELINE_DATA[7].img} alt="" className="w-10 h-10 rounded-full mb-1 border border-white" />
            <p className="text-[.7rem] font-medium text-[#4A5568] leading-tight">{TIMELINE_DATA[7].text}</p>
        ...
        <div className="block lg:hidden relative pl-8 border-l-4 border-[#00A8E8]/50 ml-6 mr-4 space-y-12">
          {TIMELINE_DATA.map((milestone, idx) => (
            <motion.div
              ...
              className="relative flex flex-col items-start bg-white p-5 rounded-xl shadow-sm border border-gray-100"
            >
              <div className="absolute -left-10 top-6 w-4 h-4 rounded-full bg-[#EF4444] border-4 border-[#E5E9EC]" />
