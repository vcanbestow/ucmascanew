...
export default function Button({
    ...
    const variants = {
        ...
        header_ucmas_white_btn_outline: "max-w-full px-4 py-2 bg-white border border-ucmas-headerbtn text-ucmas-headerbtn hover:-translate-y-[0.125rem] hover:shadow group text-sm hover:shadow-[rgba(239,51,64,0.3)_0rem_.625rem_.9375rem_-.1875rem] break-words whitespace-normal text-center inline-flex flex-wrap  items-center justify-center", // Fixed syntax bug in your original shadow color map
